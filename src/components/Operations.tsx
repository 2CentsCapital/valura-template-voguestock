    ...
    <section className="border-t border-gray-100 bg-white py-16 sm:py-24" id="how">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="relative flex flex-col items-start justify-center gap-6 overflow-hidden rounded-3xl border border-gray-100 bg-brand-light p-8 sm:p-12 lg:col-span-7">
            ...
            <div className="relative z-10 w-full font-sans">
              ...
              <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center">
                <a
                  href={LOGIN_URL}
                  className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-dark px-8 py-3.5 font-bold text-white transition duration-200 hover:bg-black"
                >
                  Sign In
            ...
            <div aria-hidden="true" className="relative -mx-8 mt-2 h-[260px] w-[calc(100%+4rem)] overflow-hidden sm:-mx-12 sm:w-[calc(100%+6rem)] lg:mx-0 lg:w-full">
          ...
          <ol className="flex flex-col justify-between gap-6 lg:col-span-5">
            {STEPS.map((step, index) => {
              ...
              return (
                <li
                  key={step.title}
                  className={`flex flex-1 flex-col justify-center rounded-3xl border p-6 sm:p-8 ${
                ...
                >
                  ...
                  <p className={`font-sans text-sm leading-relaxed sm:text-base ${highlighted ? 'text-brand-dark' : 'text-gray-600'}`}>
                    {step.text}
                  </p>
                </li>
              );
